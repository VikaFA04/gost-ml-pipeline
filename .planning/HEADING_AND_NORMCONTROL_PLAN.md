...
## Блок C. Презентация по нормоконтролю — future input source

Цель: использовать презентацию по нормоконтролю как источник требований для профиля форматирования диплома.

Шаги:

1. Добавить загрузку PPTX/PDF презентации как методического источника, не как проверяемого диплома.
2. Извлекать текст слайдов и таблиц требований.
...
- презентация не подменяет ГОСТ молча;
- все извлеченные правила имеют источник/слайд;
